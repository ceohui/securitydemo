...
import com.whale.security.core.validate.ValidateCodeException;
...
//        ImageCode codeInSession  = (ImageCode) sessionStrategy.getAttribute(request, ValidateCodeController.SESSION_KEY);
        ...
        String codeInRequest = ServletRequestUtils.getStringParameter(request.getRequest(), "smsCode");//即手机登录表单中的验证，吗name为smsCode
